...
public:
    double *const m_pForce;     // Pointer to total force in system
    ...
    double *const m_pPosition;  // Pointer to position in system
    double *const m_pVelocity;  // Pointer to velocity in system
